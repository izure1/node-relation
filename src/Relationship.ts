import { Relationship as RawRelationship, RelationData } from './common/Relationship'
...
export class Relationship<T> extends RawRelationship<T> {
  ...
  to(source: T, ...targets: T[]): this {
    return super.to.call(this.clone, source, ...targets)
  }
   ...
   */
  both(a: T, ...b: T[]): this {
    return super.both.call(this.clone, a, ...b)
  }
   ...
   */
  all(...nodes: T[]): this {
    return super.all.call(this.clone, ...nodes)
  }
  ...
  unlinkTo(source: T, ...targets: T[]): this {
    return super.unlinkTo.call(this.clone, source, ...targets)
  }
  ...
  unlinkBoth(a: T, ...b: T[]): this {
    return super.unlinkBoth.call(this.clone, a, ...b)
  }
   ...
   */
  drop(...nodes: T[]): this {
    return super.drop.call(this.clone, ...nodes)
  }
  ...
  merge(...datasets: RelationData<T>[][]): this {
    return super.merge.call(this.clone, ...datasets)
  }
}
